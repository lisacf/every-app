...
cupcake_four.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
...
cupcake_four.recipes.build  [recipe_name: "Kahlua Faux-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
ingredients: "1/2 cup margarine\n
3 cups confectioner\'s sugar\n
1/4 cup cocoa powder\n
1/2 teaspoon pure vanilla extract\n 
...
cupcake_five = Cupcake.create(name: "Vanilla", description: "A classic party cake that can be iced with colorful frosting. Egg whites give
...
ingredients: "2 1/4 cups cake flour\n
1 cup milk\n
6 large egg whites\n
...
cupcake_five.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
...
# cupcake_six.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
# ingredients: "
...
# cupcake_six.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
# ingredients: "",
...
# cupcake_seven.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
# ingredients: "
...
# cupcake_seven.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
# ingredients: "",
# instructions: "", preptime:15]
# cupcake_seven.save
...
# cupcake_eight.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
# ingredients: "
...
# cupcake_eight.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
# ingredients: "",
# instructions: "", preptime:15]
# cupcake_eight.save
...
# cupcake_nine.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
# ingredients: "
...
# cupcake_nine.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
# ingredients: "",
# instructions: "", preptime:15]
# cupcake_nine.save
...
# cupcake_ten.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
# ingredients: "
...
# cupcake_ten.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
# ingredients: "",
# instructions: "", preptime:15]
# cupcake_ten.save
...
# cupcake_eleven.recipes.build [recipe_name: "Mocha", cupcake_part: "cake", user_id: 1, 
# ingredients: "
...
# cupcake_eleven.recipes.build  [recipe_name: "Vanilla-Butter-Cream", cupcake_part: "frosting", user_id: 1, 
# ingredients: "",
# instructions: "", preptime:15]
# cupcake_eleven.save
